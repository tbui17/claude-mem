...
This project is indexed by GitNexus as **claude-mem** (19493 symbols, 38137 relationships, 286 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
