    ...
    authFetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        setSettings({
          ...
          CLAUDE_MEM_OPENAI_COMPAT_BASE_URL: data.CLAUDE_MEM_OPENAI_COMPAT_BASE_URL ?? DEFAULT_SETTINGS.CLAUDE_MEM_OPENAI_COMPAT_BASE_URL,
          CLAUDE_MEM_OPENAI_COMPAT_MODEL: data.CLAUDE_MEM_OPENAI_COMPAT_MODEL ?? DEFAULT_SETTINGS.CLAUDE_MEM_OPENAI_COMPAT_MODEL,
          CLAUDE_MEM_OPENAI_COMPAT_PROVIDER_NAME: data.CLAUDE_MEM_OPENAI_COMPAT_PROVIDER_NAME ?? DEFAULT_SETTINGS.CLAUDE_MEM_OPENAI_COMPAT_PROVIDER_NAME,
          CLAUDE_MEM_OPENAI_COMPAT_HEADERS_JSON: data.CLAUDE_MEM_OPENAI_COMPAT_HEADERS_JSON ?? DEFAULT_SETTINGS.CLAUDE_MEM_OPENAI_COMPAT_HEADERS_JSON,
          CLAUDE_MEM_OPENAI_COMPAT_MAX_CONTEXT_MESSAGES: data.CLAUDE_MEM_OPENAI_COMPAT_MAX_CONTEXT_MESSAGES ?? DEFAULT_SETTINGS.CLAUDE_MEM_OPENAI_COMPAT_MAX_CONTEXT_MESSAGES,
          CLAUDE_MEM_OPENAI_COMPAT_MAX_TOKENS: data.CLAUDE_MEM_OPENAI_COMPAT_MAX_TOKENS ?? DEFAULT_SETTINGS.CLAUDE_MEM_OPENAI_COMPAT_MAX_TOKENS,
          CLAUDE_MEM_OPENCODE_GO_API_KEY: data.CLAUDE_MEM_OPENCODE_GO_API_KEY ?? DEFAULT_SETTINGS.CLAUDE_MEM_OPENCODE_GO_API_KEY,
          CLAUDE_MEM_OPENCODE_GO_BASE_URL: data.CLAUDE_MEM_OPENCODE_GO_BASE_URL ?? DEFAULT_SETTINGS.CLAUDE_MEM_OPENCODE_GO_BASE_URL,
          CLAUDE_MEM_OPENCODE_GO_MODEL: data.CLAUDE_MEM_OPENCODE_GO_MODEL ?? DEFAULT_SETTINGS.CLAUDE_MEM_OPENCODE_GO_MODEL,
